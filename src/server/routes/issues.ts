...
function mapIssueRow(row: Record<string, unknown>): IssueResponse {
  return {
    ...
    help: row.help as string | null,
    helpUrl: row.help_url as string | null,
    wcagTags: row.wcag_tags as string[],
    selector: row.selector as string | null,
    html: row.html as string | null,
    xpath: row.xpath as string | null,
    checkSource: row.check_source as string,
    category: row.category as string | null,
    suggestedFix: row.suggested_fix as string | null,
    fixConfidence: row.fix_confidence as string | null,
    llmConfidence: (row.llm_confidence as string | null) ?? null,
    wcagCriterion: extractWcagCriterion(row.wcag_tags as string[] | undefined, row.rule as string),
