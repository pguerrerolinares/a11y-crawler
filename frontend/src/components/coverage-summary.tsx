      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            ...
            {withFindings.length > 0 && ` ${withFindings.length} criteria had findings in this audit.`}
          </p>
          <p className="text-xs text-muted-foreground mt-2">
            A manual audit typically covers 5–10 pages and costs thousands of euros.
            ...
            <div className="space-y-1">
              {withFindings.map(c => (
                <div key={c.criterion} className="flex items-center gap-2 text-sm">
                  ...
                  <span className="font-mono text-xs w-10 shrink-0">{c.criterion}</span>
                  <span>{c.name}</span>
